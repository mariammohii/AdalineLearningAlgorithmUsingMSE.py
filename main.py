...
########################### data split
def data_split(classes, features, learn, epo, bias,thres):
    ...
    #################### feature train and test
    weights = singleLayerPrecept_train(x_trian, train['species'], learn, epo, bias, first_class, second_class, features,thres)
...
def singleLayerPrecept_train(input_data, actualData, learningRate, epochs, bias, first_class, second_class, features,thres):
    sum=0
...
def get_data():
    ...
    #########################filtering data
    data_split(selected_classes, selected_features, learning_rate, epochs, bias,thresh)
    #########################filtering data
...
if __name__ == "__main__":
    ...
    ######################### threshold
    # ----------number of epochs label----------
    epo = Label(master, text="Threshold:", font=('Times New Roman', '12'))
    epo.place(x=280, y=10)
    # ----------number of epochs input---------
    threshold = StringVar()
    threshold_entry = Entry(master, textvariable=threshold, width="20")
    threshold_entry.place(x=360, y=10)
    ######################### threshold
    ...
    # ----------label---------
    feature1 = Label(master, text="---------------- choose 2 feature for the second graph -------------------",
